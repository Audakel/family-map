...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.audakel.fammap/http/host/path")
        );
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(Activity activity, String username, String password, String server, int port) {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                writeToSharedPrefs(USER_AUTH, response.getString(USER_AUTH));
        ...
        private void writeToSharedPrefs(String key, String value){
            SharedPreferences sharedPref = mActivity.getSharedPreferences(SHARAED_PREFS_BASE,Context.MODE_PRIVATE);
            SharedPreferences.Editor editor = sharedPref.edit();
            editor.putString(SHARAED_PREFS_BASE + key, value);
            editor.commit();
        }
